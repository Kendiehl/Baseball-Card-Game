  ...
  return (
    <g>
      {/* Cap silhouette — rises ~10px to peak, tumbles, lands at +ldx/+ldy
          from start. The full transform combines a translate (parabolic
          x + y motion) AND a rotate (full spin) over 800ms. */}
      <g>
        <animateTransform attributeName="transform" type="translate"
  ...
  if (phase === 'setup') {
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center p-10 font-sans text-gray-900">
        <h1 className="text-4xl font-black text-blue-900 mb-2 tracking-tight uppercase">⚾ Card Baseball v87</h1>
