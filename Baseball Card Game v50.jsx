...
function BaseballCardGameInner() {
  ...
  function transitionHalf() {
    ...
    // innings 4-7 (skipping the stretch frame and any game-ending half), at
    // 25% per eligible transition. Suppressed when game is over so it doesn't
    // play over the post-game modal.
    const crowdWaveEligible = !g.gameOver && !is7thStretch
  ...
  if (phase === 'setup') {
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center p-10 font-sans text-gray-900">
        <h1 className="text-4xl font-black text-blue-900 mb-2 tracking-tight uppercase">⚾ Card Baseball v48</h1>
