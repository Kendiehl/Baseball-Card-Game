...
function SVGBatter({ x, y, color = '#dc2626', phase = 'stance', side = 'R' }) {
  ...
  const ba = isBunt ? (l ? 5 : -5) : isSwing ? (l ? -70 : 70) : (l ? 30 : -30);
  ...
  return (<g transform={`translate(${x + stepOffset},${y})`}>
    ...
    {isBunt ? (
      ...
      <g transform={`rotate(${batDown},${batX},${batY})`}><line x1={batX} y1={batY} x2={batX} y2={batLen} stroke="#b8860b" strokeWidth={2.5} strokeLinecap="round" /></g>
    )}
...
function BaseballCardGameInner() {
  ...
  function doDrawCard() {
    ...
    // Pitcher fatigue: after 100 pitches, outcomes may upgrade
    const defTeam = 1 - bt;
    ...
    // Batter occasionally steps out of the box before pitch (~15% chance)
