...
function BaseballCardGameInner() {
  ...
  function processOutcome(oc, card, nar, animated = false, result = null) {
    ...
    const isClosePlay = hadRunnerOn3rd && ['single', 'error', 'groundOut', 'flyOut', 'lineOut'].includes(oc) && res.runs > 0 && Math.random() < 0.25;
    if (isClosePlay) {
    ...
    if (nO >= 3) setTimeout(() => transitionHalf(), isClosePlay ? 3000 : 1500);
  ...
  if (phase === 'setup') {
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center p-10 font-sans text-gray-900">
        <h1 className="text-4xl font-black text-blue-900 mb-2 tracking-tight uppercase">⚾ Card Baseball v10</h1>
