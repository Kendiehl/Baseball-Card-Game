...
function BaseballCardGameInner() {
  ...
  function doDrawCard() {
    ...
    if (oc === 'single' && gs.current.bases[2] && res.runs >= 1
    ...
    // outfield assist) — those have their own narration and shouldn't double up.
    let isTexasLeaguer = false;
    if (oc === 'single' && !isLostInSun && !isOutfieldAssist && Math.random() < 0.12) {
      isTexasLeaguer = true;
    }
