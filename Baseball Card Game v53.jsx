  ...
  function doDrawCard() {
    ...
    if (oc === 'groundOut' && !gs.current.bases[0] && gs.current.inning >= 6 && Math.random() < 0.04) {
      ...
      if (challengeOverturned) {
        ...
        // outcome will be a single after review.
