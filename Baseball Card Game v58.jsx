...
function BaseballCardGameInner() {
  ...
  function doDrawCard() {
    ...
    const doesShakeOff = !doesStepOut && !stealHomeEvent && !stolenBaseEvent && oc !== 'hbp' && Math.random() < 0.25;
    ...
    }, 550 + stepOutDelay + shakeOffDelay);
    ...
    if (doesSwing(oc)) {
      ...
      }, 1050 + stepOutDelay + shakeOffDelay);
      setTimeout(() => {
      ...
      }, 1100 + stepOutDelay + shakeOffDelay);
    } else setTimeout(() => setAnnounceText(nar.text), 1100 + stepOutDelay + shakeOffDelay);
  }
