  ...
  return (
    <div className="relative w-full max-w-[750px] mx-auto overflow-hidden rounded-xl shadow-2xl">
      ...
      <svg viewBox="0 0 620 500" className="w-full h-auto block bg-blue-100 font-sans">
        ...
        {!rosinAct && <SVGPitcher x={F.P.x} y={F.P.y - 14} color={defColor} phase={pitcherTipCap ? 'tipCap' : (pitcherBrowWipe ? 'wipeBrow' : pitchPhase)} fromStretch={fromStretch} headShake={pitcherShakeOff} />}
...
function BaseballCardGameInner() {
  ...
  function doDrawCard() {
    ...
    }, 550 + stepOutDelay + shakeOffDelay + cleatKnockDelay + browWipeDelay);
    ...
    if (doesSwing(oc)) {
      ...
      }, 1050 + stepOutDelay + shakeOffDelay + cleatKnockDelay + browWipeDelay);
      setTimeout(() => {
      ...
      }, 1100 + stepOutDelay + shakeOffDelay + cleatKnockDelay + browWipeDelay);
    } else setTimeout(() => setAnnounceText(nar.text), 1100 + stepOutDelay + shakeOffDelay + cleatKnockDelay + browWipeDelay);
  }
