    ...
    <g transform={`translate(${x - slideOffset},${y})`}>
      {dustOpacity > 0.05 && (
        <g opacity={dustOpacity}>
          <circle cx={14} cy={8} r={5 + progress * 10} fill="#c9a25c" opacity={0.25} /><circle cx={20} cy={3} r={4 + progress * 8} fill="#c9a25c" opacity={0.2} /><circle cx={8} cy={12} r={3 + progress * 7} fill="#c9a25c" opacity={0.18} /><circle cx={25} cy={6} r={2 + progress * 9} fill="#d4b068" opacity={0.15} /><circle cx={16} cy={-2} r={2 + progress * 6} fill="#c9a25c" opacity={0.12} /><circle cx={12} cy={-4 - progress * 8} r={3 + progress * 4} fill="#c9a25c" opacity={0.1 * dustOpacity} /><circle cx={22} cy={-2 - progress * 6} r={2 + progress * 3} fill="#d4b068" opacity={0.08 * dustOpacity} />
        </g>
      )}
...
function BaseballField({ bases, defColor, offColor, ballPos, pitchPhase, batterPhase, showFW, fwKey, movingRunners, movingFielder, batterSide = 'R', platePlay = null, isPlayoff = false, pitchingChange = null, homeColor = '#b91c1c', awayColor = '#1e40af' }) {
...
function BaseballCardGameInner() {
  ...
  if (phase === 'setup') {
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center p-10 font-sans text-gray-900">
        <h1 className="text-4xl font-black text-blue-900 mb-2 tracking-tight uppercase">⚾ Card Baseball v12</h1>
  ...
  return (
    <div className="min-h-screen bg-stone-100 p-2 font-sans select-none overflow-x-hidden text-gray-900 text-[10px]">
      ...
      <BaseballField bases={displayBases} defColor={gs.current.half === 0 ? '#1e40af' : '#b91c1c'} offColor={gs.current.half === 0 ? '#b91c1c' : '#1e40af'} ballPos={ballPos} pitchPhase={pitchPhase} batterPhase={batterPhase} showFW={showFW} fwKey={fwKey} movingRunners={movingRunners} movingFielder={movingFielder} batterSide={batterSide} platePlay={platePlay} isPlayoff={isPlayoff} pitchingChange={pitchingChange} homeColor={'#b91c1c'} awayColor={'#1e40af'} />
